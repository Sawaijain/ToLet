...
const ProfileForm = () => {
    ...
    const [userData, setUserData] = useState({ name: 'John Doe', email: 'Johndoe@gmail.com', mobileNo: '1234656789', });
    ...
    return (
        <View style={styles.container}>
            <View style={{ flex: 1, }}>
                {/* <View>
                    <Pressable style={{ alignSelf: 'flex-end', paddingHorizontal: '7%', paddingTop: '5%', fontSize: 18, color: '#7941f2' }}>
                        <MaterialIcons
                            size={28}
                            name="mode-edit"
                        ...
                        <>
                            ...
                            <View style={styles.action}>
                                ...
                                <TextInput
                                    ...
                                    autoCapitalize="none"
                                    onChangeText={(val) => setUserData({ ...data, name: val })}
                        ...
                        <>
                            ...
                            <View style={styles.action}>
                                ...
                                <TextInput
                                    ...
                                    style={styles.textInput}
                                    autoCapitalize="none"
                                    onChangeText={(val) => setUserData({ ...data, email: val })}
                                />
                                <TouchableOpacity
                        ...
                        <>
                            ...
                            <View style={styles.action}>
                                ...
                                <TextInput
                                    ...
                                    style={styles.textInput}
                                    autoCapitalize="none"
                                    onChangeText={(val) => setUserData({ ...data, mobileNo: val })}
                                />
                                <TouchableOpacity
                                // onPress={updateSecureTextEntry}
                                >
